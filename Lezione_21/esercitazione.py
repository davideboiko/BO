...
class Documento:
    ...
    def isInText(self, parola_c: str) -> bool:
        return parola_c in self.text


class Email(Documento):
    def __init__(self, text: str, mittente: str, destinatario: str, titolo_m: str):
        super().__init__(text)
        self.mittente = mittente
        self.destinatario = destinatario
        self.titolo_m = titolo_m
    ...
    def setTitolo_m(self, titolo_m: str):
        self.titolo_m = titolo_m

    def getTitolo_m(self):
        return self.titolo_m
